...
client.droplets.getAction(123, 456, callback);</code></pre><h2>Client Options</h2><p>The DigitalOcean client depends on <a href="https://github.com/request/request"><code>request</code></a>, and <a href="https://github.com/request/request#requestoptions-callback">options can be passed through</a> (e.g. a proxy or user agent). For example:</p>
...
<h3>Drive resource</h3><pre class="prettyprint source lang-js"><code>var digitalocean = require('digitalocean');
var client = digitalocean.client('TOKEN');
client.drives</code></pre><ul>
<li><code>client.drives.list([page, perPage,] [callback])</code></li>
<li><code>client.drives.list([queryObject,] [callback])</code></li>
</ul>
<p><a href="https://developers.digitalocean.com/documentation/v2/block-storage-beta/#retrieve-an-existing-block-storage-drive-by-name">See the official docs</a> on different parameters to pass via the query object to filter the drives.</p>
<ul>
<li><code>client.drives.get(tag.name, [callback])</code></li>
<li><code>client.drives.create(attributes, [callback])</code></li>
</ul>
<p>For the latest valid attributes, <a href="https://developers.digitalocean.com/documentation/v2/block-storage-beta/#create-a-new-block-storage-drive">see the official docs</a>.</p>
<ul>
<li><code>client.drives.delete(tag.name, [callback])</code></li>
</ul>
<p>Methods resulting in an <code>action</code>:</p>
<ul>
<li><code>client.drives.attach(drive.id, parametersOrDropletId, [callback])</code></li>
<li><code>client.drives.detach(drive.id, [callback])</code></li>
<li><code>client.drives.listActions(drive.id, [page, perPage,] [callback])</code></li>
<li><code>client.drives.listActions(drive.id, [queryObject,] [callback])</code></li>
<li><code>client.drives.getAction(drive.id, action.id, [callback])</code></li>
</ul>
...
<h3>Volume resource</h3><pre class="prettyprint source lang-js"><code>var digitalocean = require('digitalocean');
var client = digitalocean.client('TOKEN');
...
<li><code>client.volumes.getAction(volume.id, [callback])</code></li>
</ul>
<p>For the latest valid attributes, <a href="https://developers.digitalocean.com/documentation/v2/#volumes">see the official docs</a>.</p>
<p>Methods resulting in an <code>action</code>:</p>
<ul>
